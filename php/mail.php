<?php
    $to = 'nurmanbetovbekbolot@gmail.com'; // Replace this Mail ID with yours
    $websiteURL = "http://backbolot.com"; // Replace Your Website URL for Show Logo
	$websiteName = "backbolot"; // Replace Your Website Name for Show Logo alt Text.
